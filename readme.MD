...
```
mysql -h expense-dev.cahamswms5pz.us-east-1.rds.amazonaws.com -u root -pExpenseApp1
```
```
USE transactions;
```
...
--attach-policy-arn=arn:aws:iam::361769594412:policy/AWSLoadBalancerControllerIAMPolicy \
